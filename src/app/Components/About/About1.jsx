...
const About1 = () => {
    ...
    const AboutInfoText = {
        Content:'I am  a visionary creative designer, known for my ability to turn concepts into captivating visual narratives. My deep passion for the world of design allows me to craft compelling stories through my artistic ingenuity.'
      }

    const AboutContent = [
        {title:'Born In', text:'California, San Francisco'},
        {title:'Experience', text:'10 Years Experience'},
        {title:'Date of Birth', text:'20 September, 1992'},
        {title:'Language', text:'German, English, Spanish'}
      ];

      const experienceInfo = {
        number:'10',
        content:'Years of Experiences UI/UX Design sector powerful design'
      }
